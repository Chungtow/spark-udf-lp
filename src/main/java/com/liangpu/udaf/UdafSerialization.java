 ...
 *
 * <p>Spark 3.3.1 集群对 Hive UDAF 的 partial 传输机制（hiveUDFs.scala
 ...
 *       {@code writableStringObjectInspector}——Spark 3.3.1 序列化/反序列化后
...
public final class UdafSerialization {
    ...
    /**
     * 中间态 → Base64 编码的 {@link Text}（Spark 3.3.1 partial 传输载体，
    ...
    /**
     * Spark 3.3.1 反序列化后还原的 partial（{@link Text} 或 java String）→ 中间态对象。
     */
